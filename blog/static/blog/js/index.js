...
$(document).ready(function(e){
        ...
        $("#btn_registrar").click(function(e) {
            ...
            if (docu == 'boleta' ){
                ...
                if(est == 'entrante'){
                    $('#tbl_ventas tr:last').after("<tr style='background-color:#CCC'><td>"+num+"</td><td>"+cli+"</td><td>"+cant+"</td><td>"+docu+"</td><td>"+neto+"</td><td>"+total+"</td><td><i class='material-icons'>arrow_back</i></td></tr>");
                }else{
                    $('#tbl_ventas tr:last').after("<tr style='background-color:#CCC'><td>"+num+"</td><td>"+cli+"</td><td>"+cant+"</td><td>"+docu+"</td><td>"+neto+"</td><td>"+total+"</td><td><i class='material-icons'>arrow_forward</i></td></tr>");
                }
                
            }else{
                //Preguntamos si es entrante o saliente
                if(est == 'entrante'){
                    $('#tbl_ventas tr:last').after("<tr style='background-color:#333'><td>"+num+"</td><td>"+cli+"</td><td>"+cant+"</td><td>"+docu+"</td><td>"+neto+"</td><td>"+total+"</td><td><i class='material-icons'>arrow_back</i></td></tr>");
                }else{
                    $('#tbl_ventas tr:last').after("<tr style='background-color:#333'><td>"+num+"</td><td>"+cli+"</td><td>"+cant+"</td><td>"+docu+"</td><td>"+neto+"</td><td>"+total+"</td><td><i class='material-icons'>arrow_forward</i></td></tr>");
                    }
            }
